...
class OCRModel:
    ...
    def detect_lines(self, images: List[Image.Image], batch_size: int = 32):
    ...
    def extract_text(self, images: List[Image.Image], bboxes: List[List[List[float]]], langs: List[str] = None, batch_size: int = 64):
